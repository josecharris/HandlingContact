...
class HandlingPersistenceContactTestSER {
	...
	void test2() {
		...
		this.handlingPersitenceContact.loadFile(ETypeFile.SER);
		
		Assert.assertEquals(4, this.handlingPersitenceContact.getListContacts().size());
